...
class MyZefyrScaffold extends StatefulWidget {
  final Widget child;

  const MyZefyrScaffold({Key key, this.child}) : super(key: key);
...
class ZefyrScaffoldState extends State<MyZefyrScaffold> {
