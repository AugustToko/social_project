...
class LyListConfig<T> extends LyLoadingMoreListConfig<T> {
...
class LySliverListConfig<T> extends LyLoadingMoreListConfig<T> {
...
class LyLoadingMoreListConfig<T> {
  //Item builder
  ...
  bool get isSliver {
    return this is LySliverListConfig<T>;
  }

  LyLoadingMoreListConfig(
    this.itemBuilder,
    this.sourceList, {
  ...
  Widget buildErrorItem(BuildContext context) {
    ...
    if (hasError) {
      ...
      widget = widget ??
          LyIndicatorWidget(IndicatorStatus.error, isSliver: isSliver,
              tryAgain: () {
            sourceList.errorRefresh();
          });
      return widget;
